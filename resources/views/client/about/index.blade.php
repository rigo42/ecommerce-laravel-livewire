...
<div class="container">
    <div class="page-header page-header-big text-center" style="background-image: url('https://portotheme.com/html/molla/assets/images/about-header-bg.jpg')">
        <h1 class="page-title text-white">Nosotros<span class="text-white">¿Quiénes somos?</span></h1>
    </div><!-- End .page-header -->
</div><!-- End .container -->
...
<div class="page-content pb-0">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mb-3 mb-lg-0">
                <h2 class="title">Nuestra visión</h2><!-- End .title -->
                <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Phasellus hendrerit. Pellentesque aliquet nibh nec urna. In nisi neque, aliquet vel, dapibus id, mattis vel, nisi. Sed pretium, ligula sollicitudin laoreet viverra, tortor libero sodales leo, eget blandit nunc tortor eu nibh. </p>
            </div><!-- End .col-lg-6 -->
            
            <div class="col-lg-6">
                <h2 class="title">Nuestra misión</h2><!-- End .title -->
            ...
            <div class="row">
                ...
                <div class="col-lg-6 offset-lg-1">
                    <div class="about-images">
                        <img src="https://portotheme.com/html/molla/assets/images/about/img-1.jpg" alt="" class="about-img-front">
                        <img src="https://portotheme.com/html/molla/assets/images/about/img-2.jpg" alt="" class="about-img-back">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
                <div class="brands-text">
                    <h2 class="title">Conoce nuestros clientes</h2><!-- End .title -->
        ...
        <h2 class="title text-center mb-4">#Team</h2><!-- End .title text-center mb-2 -->

        <div class="row">
            <div class="col-md-4">
                <div class="member member-anim text-center">
                    <figure class="member-media">
                        <img src="https://portotheme.com/html/molla/assets/images/team/member-1.jpg" alt="member photo">

                        <figcaption class="member-overlay">
                            <div class="member-overlay-content">
                                <h3 class="member-title">Personal 1 <span>Founder & CEO</span></h3><!-- End .member-title -->
                                <p class="text-white">Sed pretium, ligula sollicitudin viverra, tortor libero sodales leo, eget blandit nunc.</p> 
            ...
            <div class="col-md-4">
                <div class="member member-anim text-center">
                    <figure class="member-media">
                        <img src="https://portotheme.com/html/molla/assets/images/team/member-2.jpg" alt="member photo">
            ...
            <div class="col-md-4">
                <div class="member member-anim text-center">
                    <figure class="member-media">
                        <img src="https://portotheme.com/html/molla/assets/images/team/member-3.jpg" alt="member photo">
    ...
    <div class="about-testimonials bg-light-2 pt-6 pb-6">
        <div class="container">
            <h2 class="title text-center mb-3">¿Qué dicen acerca de nosotros?</h2><!-- End .title text-center -->
            ...
            <div class="owl-carousel owl-simple owl-testimonials-photo" data-toggle="owl" 
                ...
                <blockquote class="testimonial text-center">
                    <img src="https://portotheme.com/html/molla/assets/images/testimonials/user-1.jpg" alt="user">
                ...
                <blockquote class="testimonial text-center">
                    <img src="https://portotheme.com/html/molla/assets/images/testimonials/user-2.jpg" alt="user">
