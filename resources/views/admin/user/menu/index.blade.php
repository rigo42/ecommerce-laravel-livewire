        ...
        <div class="card-body pt-20">
            <div class="text-center mb-10">
                <div class="symbol symbol-60 symbol-circle symbol-xl-90">
                    <div class="symbol-label" style="background-image:url({{ $user->profile() }})"></div>
                </div>
            ...
            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                ...
                <div class="navi-item mb-2">
                    <a href="{{ route('admin.user.show', $user) }}" class="navi-link py-4 {{ active('user.show') }}">
                ...
                <div class="navi-item mb-2">
                    <a href="{{ route('admin.user.edit', $user) }}" class="navi-link py-4 {{ active('user.edit') }}">
                        <span class="navi-icon mr-2">
                            <span class="svg-icon">
                ...
                <div class="navi-item mb-2">
                    <a href="{{ route('admin.user.password', $user) }}" class="navi-link py-4 {{ active('user.password') }}">
                        <span class="navi-icon mr-2">
                ...
                @can('ajustes')
                <div class="navi-item mb-2">
                    <a href="{{ route('admin.user.permission', $user) }}" class="navi-link py-4 {{ active('user.permission') }}">
                        <span class="navi-icon mr-2">
                ...
                <div class="navi-item mb-2">
                    <a href="{{ route('admin.user.log', $user) }}" class="navi-link py-4 {{ active('user.log') }}">
                        <span class="navi-icon mr-2">
                            <i class="fa fa-eye"></i>
                        </span>
