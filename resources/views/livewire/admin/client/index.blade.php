                            ...
                            <div class="d-flex justify-content-end">
                                <div class="dropdown dropdown-inline" data-toggle="tooltip"  data-placement="left">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        ...
                                        @endcan --}}
                                        <a class="dropdown-item" href="{{ route('admin.client.show', $client) }}"><i class="fa fa-eye mr-2"></i> Ver</a>
                            ...
                            <div class="d-flex align-items-end mb-7">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <a href="{{ route('admin.client.show', $client) }}" class="text-dark font-weight-bold text-hover-primary font-size-h4 mb-0">{{ $client->name }}</a>
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-px text-center py-20 my-10">
                    ...
                    <a href="{{ route('admin.client.create') }}" class="btn btn-primary">Agregar cliente</a>
                </div>
