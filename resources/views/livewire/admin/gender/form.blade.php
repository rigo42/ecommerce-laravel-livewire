                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <div class="input-group input-group-solid">
                                <input 
                                    wire:model.defer="gender.name" 
                                    type="text" 
                                    required
                                    class="form-control form-control-solid @error('gender.name') is-invalid @enderror"  
                                    placeholder="Ingresa un nombre" />
                            </div>
                            @error('gender.name') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                    </div>
                </div>
            </div>
