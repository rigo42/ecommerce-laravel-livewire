                                            ...
                                            <div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="left"  style="position: initial!important;">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-md dropdown-menu-right" style="position: inherit;">
                                                    ...
                                                    <ul class="navi navi-hover py-5">
                                                        <li class="navi-item">
                                                            <a href="{{ route('admin.user.show', $user) }}" class="navi-link">
                                                        ...
                                                        <li class="navi-item">
                                                            <a href="{{ route('admin.user.edit', $user) }}" class="navi-link">
                                                                <span class="navi-icon">
                                                                    <i class="fa fa-pen"></i>
                                                                </span>
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-px text-center py-5">
                    ...
                    <a href="{{ route('admin.user.create') }}" class="btn btn-primary">Agregar usuario</a>
                </div>
