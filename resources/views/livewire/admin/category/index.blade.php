    ...
    <div class="card card-custom gutter-b">
        <div class="card-header border-0 py-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label font-weight-bolder text-dark">Categorías <span class="text-muted font-size-sm">({{ $categories->count() }})</span></span>
            </h3>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-circle symbol-50 mr-3">
                                            <img alt="{{ $category->name }}" src="{{ $category->imagePreview() }}" >
                                        </div>
                                        <div class="d-flex flex-column">
                                            <a href="#" class="text-dark-75 font-weight-bold font-size-lg">{{ $category->name }}</a>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                        ...
                                        <div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="left"  style="position: initial!important;">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right" style="position: inherit;">
                                                ...
                                                <ul class="navi navi-hover py-5">
                                                    <li class="navi-item">
                                                        <a href="#" data-toggle="modal" data-target=".edit-{{ $category->id }}" class="navi-link">
                                                    ...
                                                    <li class="navi-item" onclick="event.preventDefault(); confirmDestroy({{ $category->id }})">
