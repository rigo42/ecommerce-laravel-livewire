    ...
    <div class="card card-custom gutter-b">
        <div class="card-header border-0 py-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label font-weight-bolder text-dark">Marcas <span class="text-muted font-size-sm">({{ $brands->count() }})</span></span>
            </h3>
                ...
                <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                    ...
                    <tbody>
                        @foreach ($brands as $brand)
                            <tr>
                                <td>
                                    <span class="font-weight-bolder font-size-lg ">{{ $brand->name }}</span>
                                </td>
                                <td>0</td>
                                <td>
                                        ...
                                        <div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="left"  style="position: initial!important;">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right" style="position: inherit;">
                                                ...
                                                <ul class="navi navi-hover py-5">
                                                    <li class="navi-item">
                                                        <a href="#" data-toggle="modal" data-target=".edit-{{ $brand->id }}" class="navi-link">
                                                    ...
                                                    <li class="navi-item" onclick="event.preventDefault(); confirmDestroy({{ $brand->id }})">
